...
class WorkoutAdapter(private val context: Context, private var listWorkouts : List<Workout>, private val
    workoutService: WorkoutService) : RecyclerView.Adapter<WorkoutAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        val resourceId = context.resources.getIdentifier(workout.image, "drawable", context.packageName)
